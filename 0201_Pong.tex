...
\lstsource{SRC/01 Beispiele/01 Pong/pong01.py}{23}{55}{python}{Pong (\reqref{req0201Standard}) -- die Klasse \texttt{Game}
}{srcPong01c}

Der Vollständigkeit halber: 

\lstsource{SRC/01 Beispiele/01 Pong/pong01.py}{58}{999}{python}{Pong (\reqref{req0201Standard}) -- die Klasse \texttt{Game}
}{srcPong01d}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{50}{55}{python}{Pong (\reqref{req0201Schläger}) -- \texttt{Paddle.\_move()}
}{srcPong02c}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{64}{68}{python}{Pong (\reqref{req0201Schläger}) -- Konstruktor von \texttt{Game}
}{srcPong02d}

In \texttt{update()} und \texttt{draw()} erfolgen lediglich der entsprechende Methodenaufruf der Spritegroup.

\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{81}{88}{python}{Pong (\reqref{req0201Schläger}) --\texttt{Game.update()} und \texttt{Game.draw()}
}{srcPong02e}

Und jetzt werden die Tastaturevents verarbeitet. Dabei löst das Drücken einer Taste eine Bewegung aus (ab \zeiref{srcPong0211}) und das Loslassen führt zu einem Anhalten des entsprechenden Schlägers (ab \zeiref{srcPong0212}). 
...
\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{90}{109}{python}{Pong (\reqref{req0201Schläger}) -- \texttt{Game.watch\_for\_events()}
}{srcPong02f}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{60}{67}{python}{Pong (\reqref{req0201Ball}) -- Konstruktor von \texttt{Ball}
}{srcPong03a}

In \texttt{update()} werden die Aufgaben verteilt.

\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{69}{79}{python}{Pong (\reqref{req0201Ball}) -- \texttt{Ball.update()}
}{srcPong03b}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{81}{95}{python}{Pong (\reqref{req0201Ball}) -- \texttt{Ball.\_move()}
}{srcPong03c}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{97}{101}{python}{Pong (\reqref{req0201Ball}) -- \texttt{Ball.\_service()}}{srcPong03d}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{103}{107}{python}{Pong (\reqref{req0201Ball}) -- Die Flip-Methoden von \texttt{Ball}}{srcPong03e}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong04.py}{109}{117}{python}{Pong (\reqref{req0201Punkte}) -- Konstruktor von \texttt{Score}}{srcPong04a}

In dieser Methode wird der aktuelle Punktestand mit Hilfe des Font-Objektes gerendert und positioniert.

\lstsource{SRC/01 Beispiele/01 Pong/pong04.py}{123}{126}{python}{Pong (\reqref{req0201Punkte}) -- \texttt{Score.\_render()}}{srcPong04b}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong04.py}{119}{121}{python}{Pong (\reqref{req0201Punkte}) -- \texttt{Score.update()}}{srcPong04c}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong041.py}{115}{124}{python}{Pong (\reqref{req0201Punkte}) -- Konstruktor von \texttt{Score}}{srcPong04e}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong041.py}{126}{134}{python}{Pong (\reqref{req0201Punkte}) -- \texttt{Score.update()}}{srcPong04f}

Nun muss \texttt{Ball} nur noch das passende Event auslösen und \texttt{Game} das Event verwalten. Hier die Anpassungen in \texttt{Ball}. In der Methode \texttt{\_move()} werden die entsprechenden Stellen ersetzt. So wird beispielsweise in \zeiref{srcPong0402} die Nummer des Spielers in das Event gestopft, die den Punkt bekommt, und in \zeiref{srcPong0403} wird das Event abgeschickt.

\lstsource{SRC/01 Beispiele/01 Pong/pong041.py}{85}{101}{python}{Pong (\reqref{req0201Punkte}) -- \texttt{Ball.\_move()}}{srcPong04g}

Jetzt muss nur noch in \texttt{watch\_for\_events()} das Userevent abgegriffen werden (ab \zeiref{srcPong0404}).

\lstsource{SRC/01 Beispiele/01 Pong/pong041.py}{175}{196}{python}{Pong (\reqref{req0201Punkte}) -- \texttt{Ball.watch\_for\_events()}}{srcPong04h}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong05.py}{205}{213}{python}{Pong (\reqref{req0201Schlag}) -- \texttt{Game.\_check\_collision()}}{srcPong05a}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong05.py}{116}{118}{python}{Pong (\reqref{req0201Schlag}) -- \texttt{Ball.\_respeed()}}{srcPong05b}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{147}{159}{python}{Pong (\reqref{req0201Computer}) -- Konstruktor von \texttt{Game}}{srcPong06a}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{172}{178}{python}{Pong (\reqref{req0201Computer}) -- \texttt{Game.update()}}{srcPong06b}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{232}{238}{python}{Pong (\reqref{req0201Computer}) -- \texttt{Game.\_paddlecontroler()}}{srcPong06c}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{185}{220}{python}{Pong (\reqref{req0201Computer}) -- \texttt{Game.watch\_for\_events()}}{srcPong06d}

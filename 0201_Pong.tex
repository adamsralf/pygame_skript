...
Die Klasse \texttt{Game} besteht aus den Grundelementen, die wir in \kapref{secGrundlagen} schon gesehen haben. In \texttt{\_\_init\_\_()} wird Pygame gestartet, das Display und der Taktgeber erstellt und das Flag der Hauptprogrammschleife initialisiert. Der Hintergrund wird in einem \texttt{Group\-Single}-Objekt\myindex{pyg}{\texttt{sprite}!\texttt{GroupSingle}} abgelegt. Die restlichen Methoden sollten selbsterklärend sein.

\lstsource{SRC/01 Beispiele/01 Pong/pong01.py}{31}{65}{python}{Pong (\reqref{req0201Standard}) -- die Klasse \texttt{Game}
}{srcPong01c}

Der Vollständigkeit halber: 

\lstsource{SRC/01 Beispiele/01 Pong/pong01.py}{68}{74}{python}{Pong (\reqref{req0201Standard}) -- die Klasse \texttt{Game}
}{srcPong01d}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{66}{77}{python}{Pong (\reqref{req0201Schläger}) -- Konstruktor von \texttt{Game}
}{srcPong02d}

In \texttt{update()} und \texttt{draw()} erfolgen lediglich der entsprechende Methodenaufruf der Spritegroup.

\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{91}{97}{python}{Pong (\reqref{req0201Schläger}) --\texttt{Game.update()} und \texttt{Game.draw()}
}{srcPong02e}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong02.py}{99}{118}{python}{Pong (\reqref{req0201Schläger}) -- \texttt{Game.watch\_for\_events()}
}{srcPong02f}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{79}{89}{python}{Pong (\reqref{req0201Ball}) -- \texttt{Ball.update()}
}{srcPong03b}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{91}{104}{python}{Pong (\reqref{req0201Ball}) -- \texttt{Ball.\_move()}
}{srcPong03c}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{106}{109}{python}{Pong (\reqref{req0201Ball}) -- \texttt{Ball.\_service()}}{srcPong03d}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong03.py}{111}{115}{python}{Pong (\reqref{req0201Ball}) -- Die Flip-Methoden von \texttt{Ball}}{srcPong03e}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong04.py}{179}{200}{python}{Pong (\reqref{req0201Punkte}) -- \texttt{Ball.watch\_for\_events()}}{srcPong04h}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong05.py}{208}{214}{python}{Pong (\reqref{req0201Schlag}) -- \texttt{Game.\_check\_collision()}}{srcPong05a}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{195}{200}{python}{Pong (\reqref{req0201Computer}) -- \texttt{Game.update()}}{srcPong06b}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{252}{258}{python}{Pong (\reqref{req0201Computer}) -- \texttt{Game.\_paddlecontroler()}}{srcPong06c}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong06.py}{207}{242}{python}{Pong (\reqref{req0201Computer}) -- \texttt{Game.watch\_for\_events()}}{srcPong06d}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong07.py}{14}{21}{python}{Pong (\reqref{req0201Sound}) -- \texttt{Settings}}{srcPong07a}
...
\lstsource{SRC/01 Beispiele/01 Pong/pong07.py}{103}{107}{python}{Pong (\reqref{req0201Sound}) -- Konstruktor von \texttt{Ball}}{srcPong07b}

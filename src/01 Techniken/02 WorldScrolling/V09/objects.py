...
class Tile(pygame.sprite.Sprite):
    def __init__(self, position: tuple[float, float]) -> None:
        ...
        self.image_small = pygame.transform.scale_by(self.image, Settings.ZOOM_BIRDEYE,)#§\label{tilev0401}§
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, position: tuple[float, float]) -> None:
        ...
        self.image_small = pygame.transform.scale_by(self.image, Settings.ZOOM_BIRDEYE)#§\label{tilev0402}§
        rect = self.image_small.get_frect()
        pygame.draw.circle(self.image_small, "red", rect.center, self.radius * Settings.ZOOM_BIRDEYE.x)
...
class Mob(pygame.sprite.Sprite):
    ...
    def __init__(self) -> None:
        ...
        self.image_small = pygame.Surface(Settings.TILESIZE_WORLD.elementwise()*Settings.ZOOM_BIRDEYE, pygame.SRCALPHA)

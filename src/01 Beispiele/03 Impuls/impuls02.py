...
class Game:
    ...
    def update(self):
        ...
        for i in range(len(self._all_balls)):
            for j in range(len(self._all_balls)):
                self.ball_collision(self._all_balls.sprites()[i], self._all_balls.sprites()[j])
    ...
    def ball_collision(self, ball1: Ball, ball2: Ball) -> None:

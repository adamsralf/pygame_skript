...
class Game:
    def __init__(self) -> None:
        ...
        self._all_tiles.clear(self._screen, self._background_image)  # §\label{srcDirty0301}§
        self._all_tiles.set_timing_threshold(1000.0 / Settings.FPS)  # §\label{srcDirty0302}§
    ...
    def draw(self) -> None:
        rects = self._all_tiles.draw(self._screen)  # 2ter Parameter entfällt§\label{srcDirty0303}§

...
class Bubble(pygame.sprite.DirtySprite):
    ...
    def stung(self):
        self.kill()
        Game.points += self.radius                          # Increment points§\label{srcBubble0702}§
...
class Game:
    ...
    box = pygame.rect.Rect(90, 770, 1055, 130)                  # Ausgabebox§\label{srcBubble0700}§
    ...
    def __init__(self) -> None:
        ...
        self._all_sprites.add(Points())                        # Points§\label{srcBubble0703}§
        self._running = True
    ...
    def update(self) -> None:
        self._all_sprites.update(action="grow")                 # §\label{srcBubble0705}§
        self.spawn_bubble()
    ...
    def sting(self, mousepos: Tuple[int, int]) -> None:
        for bubble in self._all_sprites:
            if self.collidepoint(mousepos, bubble):
                bubble.update(action="sting")                  # Nach Bubble verschoben§\label{srcBubble0704}§

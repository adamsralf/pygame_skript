...
class Pause:
    def __init__(self) -> None:
        ...
        self._image.set_alpha(150)                              # Halbtransparenz§\label{srcBubble1105}§
        self._rect_image = self._image.get_rect()
        font_bigsize = pygame.font.Font(pygame.font.get_default_font(), 40)
        self._text = font_bigsize.render("PAUSE", True, (255, 0, 0))
...
class BubbleContainer:
    def __init__(self, filename: str) -> None:                  # Jetzt mit Dateinamen§\label{srcBubble10902}§
...
class Game:
    ...
    def watch_for_events(self) -> None:
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                elif event.button == 3:                         # right§\label{srcBubble1104}§
                    self._pausing = not self._pausing
    ...
    def draw(self) -> None:
        ...
        if self._pausing:                                       # Pausenbildschirm§\label{srcBubble1106}§

...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles03.py}{20}{21}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Settings}}{srcBubbles03a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{189}{192}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles07c}  

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{152}{155}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Game}}{srcbubbles07d}  

...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{31}{41}{python}{Bubbles (\reqref{reqStandard}.\ref{reqStandardHintergrund}) -- \texttt{Background
}}{srcBubbles01c}
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{44}{80}{python}{Bubbles (\reqref{reqStandard}) -- Methoden von \texttt{Game}}{srcBubbles01d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{83}{999}{python}{Bubbles (\reqref{reqStandard}) -- Aufruf}{srcBubbles01s}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{19}{21}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- Ergänzungen in \texttt{Settings}}{srcBubbles02a}
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{36}{48}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{Timer}}{srcBubbles02b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{61}{78}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{Bubble}}{srcBubbles02c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{81}{92}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- Konstruktor von \texttt{Game}}{srcBubbles02d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{102}{107}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{draw()} und \texttt{update()} von \texttt{Game}}{srcBubbles02e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{109}{119}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{spawn\_bubble()} von \texttt{Game}}{srcBubbles02f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles03.py}{22}{22}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Settings}}{srcBubbles03a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles03.py}{112}{123}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Game} in \texttt{spawn\_bubbles()}}{srcBubbles03b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{62}{71}{python}{Bubbles (\reqref{reqBlasenWachstum}.\ref{reqBlasenWachstumContainer}) -- \texttt{BubbleContainer}}{srcBubbles04a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{19}{19}{python}{Bubbles (\reqref{reqBlasenWachstum}.\ref{reqBlasenWachstumMax}) -- Erweiterung von \texttt{Settings}}{srcBubbles04b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{74}{101}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{Bubble}}{srcBubbles04c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{130}{133}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{update()} in \texttt{Game}}{srcBubbles04d}  

Der BubbleContainer wird angelegt

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{109}{111}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung im Konstruktor von \texttt{Game}}{srcBubbles04f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{134}{138}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{spawn\_bubble()} in \texttt{Game}}{srcBubbles04e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles05.py}{149}{154}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{collidepoint()} in \texttt{Game}}{srcbubbles05a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles05.py}{131}{134}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{update()} in \texttt{Game}}{srcbubbles05c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles06.py}{119}{128}{python}{Bubbles (\reqref{reqBlasenzerplatzen}) -- \texttt{watch\_for\_event()} in \texttt{Game}}{srcbubbles06a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles06.py}{171}{174}{python}{Bubbles (\reqref{reqBlasenzerplatzen}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles06b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{24}{24}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandNull}) -- Erweiterung von \texttt{Game}}{srcbubbles07a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{108}{110}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{stung()} in \texttt{Bubble}}{srcbubbles07b}  

Der Aufruf von \texttt{stung()} erfolgt durch ein angepasstes \texttt{update()}.

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{88}{100}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Bubble}}{srcbubbles07b1}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{196}{199}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles07c}  

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{159}{162}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Game}}{srcbubbles07d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{25}{25}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- Erweiterung von \texttt{Settings}}{srcbubbles07e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{113}{126}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- \texttt{Points}}{srcbubbles07f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{140}{142}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- Erweiterung des Konstruktors von \texttt{Game}}{srcbubbles07g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{86}{86}{python}{Bubbles (\reqref{reqSpielende}) -- \texttt{Bubble.speed}}{srcbubbles08x}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{162}{168}{python}{Bubbles (\reqref{reqSpielende}) -- Erweiterung von \texttt{update()} in \texttt{Game}}{srcbubbles08a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{207}{218}{python}{Bubbles (\reqref{reqSpielende}) -- \texttt{check\_bubblecollision()} in \texttt{Game}}{srcbubbles08b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{155}{160}{python}{Bubbles (\reqref{reqSpielende}) -- Hilfslinien in \texttt{Game}}{srcbubbles08c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles09.py}{77}{86}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- \texttt{Bubble}}{srcBubbles09a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles09.py}{136}{140}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- Konstruktor von \texttt{Game}}{srcBubbles09b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles09.py}{172}{186}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- \texttt{Game.spawn\_bubble()}}{srcBubbles09c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{137}{138}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Erweiterung von \texttt{Game}}{srcbubbles10a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{65}{69}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Änderung Konstruktor von \texttt{BubbleContainer}}{srcbubbles10b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{77}{102}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Konstruktor von \texttt{Bubble} und \texttt{update()}}{srcbubbles10d}  

Ändert sich der Modus, muss die andere Farbe nachgeladen werden. Dies erfüllt die Methode \texttt{set\_mode} in \texttt{Bubble}.

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{104}{108}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- \texttt{set\_mode()} in \texttt{Bubble}}{srcbubbles10e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{223}{239}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- \texttt{check\_bubblecollision()} in \texttt{Game}}{srcbubbles10f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{241}{253}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Wartezeit in \texttt{run()}}{srcbubbles10g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{164}{164}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Konstruktor} in \texttt{Game}}{srcbubbles11b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{167}{182}{python}{Bubbles (\reqref{reqPause}) -- \texttt{watch\_for\_events()} in \texttt{Game}}{srcbubbles11c}  

Für die Darstellung der Pause, habe ich die -- vielleicht etwas überflüssige -- Klasse \texttt{Pause} implementiert. 

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{76}{82}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Pause}}{srcbubbles11d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{165}{165}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Konstruktor} in \texttt{Game}}{srcbubbles11g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{200}{205}{python}{Bubbles (\reqref{reqPause}) -- \texttt{setpause()} in \texttt{Game}}{srcbubbles11h}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{8}{8}{python}{Bubbles (\reqref{reqNeustart}) -- Erweiterung des Imports}{srcbubbles12a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{76}{82}{python}{Bubbles (\reqref{reqNeustart}) -- von \texttt{Pause} zu \texttt{Message}}{srcbubbles12b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{148}{163}{python}{Bubbles (\reqref{reqNeustart}) -- Umbau Konstruktor von \texttt{Game}}{srcbubbles12c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{206}{214}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{restart()} in \texttt{Game}}{srcbubbles12d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{193}{204}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{update()} in \texttt{Game}}{srcbubbles12e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{172}{178}{python}{Bubbles (\reqref{reqNeustart}) -- Erweiterung von \texttt{watch\_for\_events()}}{srcbubbles12f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{292}{292}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{run()} in \texttt{Game}}{srcbubbles12g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{145}{147}{python}{Bubbles (\reqref{reqSound}) -- \texttt{SOUND\_CONTAINER}}{srcbubbles13a}  
...
\newpage
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{155}{159}{python}{Bubbles (\reqref{reqSound}) -- \texttt{SOUND\_CONTAINER} auffüllen}{srcbubbles13b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{241}{244}{python}{Bubbles  (\reqref{reqSound}.\ref{reqSoundErscheinen}) -- \texttt{spawn\_bubble()}}{srcbubbles13c}  

Dann, wenn in \texttt{sting()} eine Blase zerplatzt (\zeiref{srcBubble1304}):

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{265}{269}{python}{Bubbles (\reqref{reqSound}.\ref{reqSoundZerstechen}) -- \texttt{sting()}}{srcbubbles13d}  

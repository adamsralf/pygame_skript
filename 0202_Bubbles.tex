...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{1}{6}{python}{Bubbles (\reqref{reqStandard}.\ref{reqStandardGröße}) -- Präambel
}{srcBubbles01a}
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{22}{42}{python}{Bubbles (\reqref{reqStandard}.\ref{reqStandardGröße}) -- Statisches in \texttt{Game}
}{srcBubbles01b}
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{9}{19}{python}{Bubbles (\reqref{reqStandard}.\ref{reqStandardHintergrund}) -- \texttt{Background
}}{srcBubbles01c}
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{44}{78}{python}{Bubbles (\reqref{reqStandard}) -- Methoden von \texttt{Game}}{srcBubbles01d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles01.py}{81}{999}{python}{Bubbles (\reqref{reqStandard}) -- Aufruf}{srcBubbles01s}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{64}{66}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- Ergänzungen in \texttt{Game}}{srcBubbles02a}
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{10}{22}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{Timer}}{srcBubbles02b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{35}{52}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{Bubble}}{srcBubbles02c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{80}{90}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- Konstruktor von \texttt{Game}}{srcBubbles02d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{100}{105}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{draw()} und \texttt{update()} von \texttt{Game}}{srcBubbles02e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles02.py}{107}{120}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{spawn\_bubble()} von \texttt{Game}}{srcBubbles02f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles03.py}{67}{67}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Settings}}{srcBubbles03a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles03.py}{108}{122}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Game} in \texttt{spawn\_bubbles()}}{srcBubbles03b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{35}{47}{python}{Bubbles (\reqref{reqBlasenWachstum}.\ref{reqBlasenWachstumContainer}) -- \texttt{BubbleContainer}}{srcBubbles04a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{89}{89}{python}{Bubbles (\reqref{reqBlasenWachstum}.\ref{reqBlasenWachstumMax}) -- Erweiterung von \texttt{Game}}{srcBubbles04b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{50}{77}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{Bubble}}{srcBubbles04c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{131}{133}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{update()} in \texttt{Game}}{srcBubbles04d}  

Der BubbleContainer wird angelegt

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{110}{112}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung im Konstruktor von \texttt{Game}}{srcBubbles04f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles04.py}{138}{138}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{spawn\_bubble()} in \texttt{Game}}{srcBubbles04e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles05.py}{153}{158}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{collidepoint()} in \texttt{Game}}{srcbubbles05a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles05.py}{160}{170}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{set\_mousecursor()} in \texttt{Game}}{srcbubbles05b}  

Die Methode \texttt{update} in \texttt{Game} muss noch um den Aufruf der Überprüfung erweitert werden.

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles05.py}{132}{135}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{update()} in \texttt{Game}}{srcbubbles05c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles06.py}{120}{129}{python}{Bubbles (\reqref{reqBlasenzerplatzen}) -- \texttt{watch\_for\_event()} in \texttt{Game}}{srcbubbles06a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles06.py}{175}{178}{python}{Bubbles (\reqref{reqBlasenzerplatzen}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles06b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{117}{117}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandNull}) -- Erweiterung von \texttt{Game}}{srcbubbles07a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{82}{84}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{stung()} in \texttt{Bubble}}{srcbubbles07b}  

Der Aufruf von \texttt{stung()} erfolgt durch ein angepasstes \texttt{update()}.

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{62}{74}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Bubble}}{srcbubbles07b1}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{200}{203}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles07c}  

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{160}{163}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Game}}{srcbubbles07d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{116}{116}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- Erweiterung von \texttt{Settings}}{srcbubbles07e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{87}{100}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- \texttt{Points}}{srcbubbles07f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles07.py}{141}{143}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- Erweiterung des Konstruktors von \texttt{Game}}{srcbubbles07g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{60}{60}{python}{Bubbles (\reqref{reqSpielende}) -- \texttt{Bubble.speed}}{srcbubbles08x}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{163}{169}{python}{Bubbles (\reqref{reqSpielende}) -- Erweiterung von \texttt{update()} in \texttt{Game}}{srcbubbles08a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{211}{223}{python}{Bubbles (\reqref{reqSpielende}) -- \texttt{check\_bubblecollision()} in \texttt{Game}}{srcbubbles08b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles08.py}{156}{161}{python}{Bubbles (\reqref{reqSpielende}) -- Hilfslinien in \texttt{Game}}{srcbubbles08c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles09.py}{51}{60}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- \texttt{Bubble}}{srcBubbles09a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles09.py}{138}{140}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- Konstruktor von \texttt{Game}}{srcBubbles09b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles09.py}{173}{176}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- \texttt{Game.spawn\_bubble()}}{srcBubbles09c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{126}{126}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Erweiterung von \texttt{Game}}{srcbubbles10a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{36}{43}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Änderung Konstruktor von \texttt{BubbleContainer}}{srcbubbles10b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{144}{147}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Änderung vom Konstruktor von \texttt{Game}}{srcbubbles10c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{51}{76}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Konstruktor von \texttt{Bubble} und \texttt{update()}}{srcbubbles10d}  

Ändert sich der Modus, muss die andere Farbe nachgeladen werden. Dies erfüllt die Methode \texttt{set\_mode} in \texttt{Bubble}.

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{78}{82}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- \texttt{set\_mode()} in \texttt{Bubble}}{srcbubbles10e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{226}{241}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- \texttt{check\_bubblecollision()} in \texttt{Game}}{srcbubbles10f}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles10.py}{244}{256}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Wartezeit in \texttt{run()}}{srcbubbles10g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{8}{9}{python}{Bubbles (\reqref{reqPause}) -- Zusätzliche Konstanten}{srcbubbles11a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{165}{165}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Konstruktor} in \texttt{Game}}{srcbubbles11b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{168}{183}{python}{Bubbles (\reqref{reqPause}) -- \texttt{watch\_for\_events()} in \texttt{Game}}{srcbubbles11c}  

Für die Darstellung der Pause, habe ich die -- vielleicht etwas überflüssige -- Klasse \texttt{Pause} implementiert. 

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{51}{57}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Pause}}{srcbubbles11d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{166}{166}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Konstruktor} in \texttt{Game}}{srcbubbles11g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles11.py}{201}{206}{python}{Bubbles (\reqref{reqPause}) -- \texttt{setpause()} in \texttt{Game}}{srcbubbles11h}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{8}{10}{python}{Bubbles (\reqref{reqNeustart}) -- Erweiterung des Imports}{srcbubbles12a}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{52}{58}{python}{Bubbles (\reqref{reqNeustart}) -- von \texttt{Pause} zu \texttt{Message}}{srcbubbles12b}  
...
\newpage
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{150}{165}{python}{Bubbles (\reqref{reqNeustart}) -- Umbau Konstruktor von \texttt{Game}}{srcbubbles12c}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{208}{216}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{restart()} in \texttt{Game}}{srcbubbles12d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{195}{206}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{update()} in \texttt{Game}}{srcbubbles12e}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{167}{186}{python}{Bubbles (\reqref{reqNeustart}) -- Erweiterung von \texttt{watch\_for\_events()}}{srcbubbles12f}  
...
\newpage
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles12.py}{286}{298}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{run()} in \texttt{Game}}{srcbubbles12g}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{120}{136}{python}{Bubbles (\reqref{reqSound}) -- \texttt{SoundContainer}}{srcbubbles13a}  
...
\newpage
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{150}{167}{python}{Bubbles (\reqref{reqSound}) -- \texttt{SoundContainer} auffüllen}{srcbubbles13b}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{230}{248}{python}{Bubbles  (\reqref{reqSound}.\ref{reqSoundErscheinen}) -- \texttt{spawn\_bubble()}}{srcbubbles13c}  

Dann, wenn in \texttt{sting()} eine Blase zerplatzt (\zeiref{srcBubble1304}):

\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{269}{273}{python}{Bubbles (\reqref{reqSound}.\ref{reqSoundZerstechen}) -- \texttt{sting()}}{srcbubbles13d}  
...
\lstsource{SRC/01 Beispiele/02 Bubbles/bubbles13.py}{199}{211}{python}{Bubbles (\reqref{reqSound}.\ref{reqSoundBerühren}) -- \texttt{update()}}{srcbubbles13e}  

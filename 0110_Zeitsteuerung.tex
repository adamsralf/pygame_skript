...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{1}{27}{python}{Zeitsteuerung (1), Version 1.0: Präambel und \texttt{Settings}}{srcZeit00a} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{30}{47}{python}{Zeitsteuerung (2), Version 1.0: \texttt{Enemy}}{srcZeit00b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{50}{65}{python}{Zeitsteuerung (3), Version 1.0: \texttt{Bullet}}{srcZeit00c} 

Im Konstruktor wird eine Spritegroup für die Feuerbälle angelegt und ein \texttt{GroupSingle}-Objekt für den Enemy. In \texttt{run()} erfolgt die übliche Abarbeitung der Teilaufgaben durch entsprechende Funktionsaufrufe. Ein kurzes Augenmerk möchte ich auf \zeiref{srcZeit0005}ff. richten. Durch den Aufruf von \texttt{pygame.time.Clock.tick()}\myindex{pyg}{\texttt{time}!\texttt{Clock}!\texttt{tick()}}\randnotiz{tick()} wird das Spiel getaktet -- hier auf das $1/60$ einer Sekunde und anschließend die \emph{Deltatime}\randnotiz{deltatime}\index{deltatime} berechnet. 

\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{68}{92}{python}{Zeitsteuerung (4), Version 1.0: Konstruktor und \texttt{run()} von \texttt{Game}}{srcZeit00d} 

Die Methoden \texttt{watch\_for\_events()} und \texttt{draw()} sind auch ohne Besonderheiten.

\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{94}{106}{python}{Zeitsteuerung (5), Version 1.0:  \texttt{watch\_for\_events()} und \texttt{draw()} von \texttt{Game}}{srcZeit00e} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{108}{114}{python}{Zeitsteuerung (6), Version 1.0:  \texttt{update()} und \texttt{new\_bullet()} von \texttt{Game}}{srcZeit00f} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit01.py}{68}{81}{python}{Zeitsteuerung (7), Version 1.1: Konstruktor von \texttt{Game}}{srcZeit01a} 
...
\newpage
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit01.py}{115}{119}{python}{Zeitsteuerung (8), Version 1.1: \texttt{new\_bullet()} von \texttt{Game}}{srcZeit01b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit02.py}{78}{81}{python}{Zeitsteuerung (9), Version 1.2: Konstruktor von \texttt{Game}}{srcZeit02a} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit02.py}{115}{118}{python}{Zeitsteuerung (10), Version 1.2: \texttt{new\_bullet()} von \texttt{Game}}{srcZeit02b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit03.py}{30}{43}{python}{Zeitsteuerung (11), Version 1.3: \texttt{Timer}}{srcZeit03a} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit03.py}{94}{96}{python}{Zeitsteuerung (12), Version 1.3: \texttt{Timer}-Objekt erzeugen}{srcZeit03b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit03.py}{130}{132}{python}{Zeitsteuerung (13), Version 1.3: \texttt{Timer}-Objekt verwenden}{srcZeit03c} 

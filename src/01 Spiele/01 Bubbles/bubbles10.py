...
class Settings:
    ...
    points = 0
    bubble_container = {}                                       # Mehrere§\label{srcBubble1001}§
...
class Bubble(pygame.sprite.Sprite):
    ...
    def update(self) -> None:
        if self._timer_growth.is_next_stop_reached():
            ...
            self.image = Settings.bubble_container[self.mode].get(self.radius)  # §\label{srcBubble1006}§
            self.rect = self.image.get_rect()
...
class Game:
    def __init__(self) -> None:
        ...
        Settings.bubble_container["blue"] = BubbleContainer("blase1.png")  # blau§\label{srcBubble1003}§
        Settings.bubble_container["red"] = BubbleContainer("blase2.png")   # rot§\label{srcBubble1004}§

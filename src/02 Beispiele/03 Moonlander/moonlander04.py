...
class Settings:
    ...
    DELTATIME = 1.0 / FPS 
    HORIZONT = 50
    # Physikalische Konstanten (Mondbedingungen)§\label{moonlander0401}§
...
class Lander:
    def __init__(self, screen: pygame.surface.Surface) -> None:
        ...
        self.velocity = 0                           # Horizontale Geschwindigkeit§\label{moonlander0402}§   
...
class Game:
    ...
    def update(self) -> None:
        ...
        self.lander.update(action="move")      # Soll sich bewegen!§\label{moonlander0403}§

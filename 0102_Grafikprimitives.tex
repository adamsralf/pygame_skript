...
Der Grundaufbau ist der gleiche wie in \srcref[vref]{srcStart01}. Die Unterschiede beginnen in \zeiref{srcPrimitives01}. Die Klasse \texttt{pygame.Color}\randnotiz{Color}\myindex{pyg}{\texttt{Color}|underline} kann Farbinformationen\index{Farbe!Information} in verschiedenen Formaten inklusive eines \glslink{alpha}{Alpha-Kanals}\index{Farbe!Alpha-Kanal}\index{Alpha-Kanal} (\glslink{alphablending}{Alpha-Blending}\index{Farbe!Alpha-Blending}\index{Alpha-Blending}, Transparenz)\index{Transparenz} kodieren; mehr dazu später in \abschnittref[vref]{secBitmapLaden}. Ich verwende hier eine RGB-Kodierung mit Farbkanalwerten zwischen~0 und~255. 

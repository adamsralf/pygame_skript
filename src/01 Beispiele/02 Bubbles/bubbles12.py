...
import pygame
from pygame.constants import K_ESCAPE, KEYDOWN, KEYUP, MOUSEBUTTONDOWN, MOUSEBUTTONUP, QUIT, K_j, K_n, K_p  # §\label{srcBubble1201}§
...
class Game:
    ...
    def __init__(self) -> None:
        ...
        self._running = True
        self._pausing = False
        self._pause = Message("pause.png")  # §\label{srcBubble1203}§
    ...
    def run(self) -> None:
        ...
        # pygame.time.wait(2000)                    # Neustart?§\label{srcBubble1209}§
        pygame.quit()

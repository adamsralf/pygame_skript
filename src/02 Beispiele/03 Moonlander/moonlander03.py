...
class Lander:
    def __init__(self, screen: pygame.surface.Surface) -> None:
        ...
        self.rect.centerx = Settings.WINDOW.centerx # horizontale Startposition§\label{moonlander0304}§
        self.rect.top = self.rect.height            # vertikale Startposition§\label{moonlander0305}§
        self.create_lander()                        # Zeichnen wird ausgelagert§\label{moonlander0301}§
        self.thrusting = False                      # Flag, ob beschleunigt wird§\label{moonlander0302}§

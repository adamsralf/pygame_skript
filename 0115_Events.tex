...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{1}{21}{python}{Events (2) -- Präambel}{srcEvent01a}
...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{24}{39}{python}{Events (2) -- Klasse \texttt{Button}}{srcEvent01b}
...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{42}{80}{python}{Events (2) -- Klasse \texttt{Particle}}{srcEvent01c}
...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{83}{108}{python}{Events (2) -- Klasse \texttt{Box}}{srcEvent01d}

Und jetzt das Hauptprogramm: Im Konstruktor werden die Buttons, Boxen und Partikel angelegt und Spritegroups zugeordnet.

\lstsource{SRC/00 Einführung/15 Events/events01.py}{111}{127}{python}{Events (2) --  Konstruktor von \texttt{Game}}{srcEvent01e}

Die Methode \texttt{run()} ist nahezu langweilig.

\lstsource{SRC/00 Einführung/15 Events/events01.py}{129}{139}{python}{Events (2) --  \texttt{Game.run()}}{srcEvent01f}
...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{141}{155}{python}{Events (2) --  \texttt{Game.watch\_for\_events()}}{srcEvent01g}

Der Rest wird hier der Vollständigkeit abgedruckt.

\lstsource{SRC/00 Einführung/15 Events/events01.py}{157}{185}{python}{Events (2) --  Der Rest von \texttt{Game}}{srcEvent01h}
...
\lstsource{SRC/00 Einführung/15 Events/events02.py}{140}{142}{python}{Events (3) -- Timer}{srcEvent02b}

Wie die anderen Events wird dieses nun in \texttt{watch\_for\_event()} abgefangen (\zeiref{srcEvent0202}) und verarbeitet. Hier indem die Methode \texttt{generate\_particles()} aufgerufen wird.

\lstsource{SRC/00 Einführung/15 Events/events02.py}{171}{172}{python}{Events (3) -- Event}{srcEvent02c}

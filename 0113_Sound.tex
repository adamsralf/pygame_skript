...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{1}{28}{python}{Sound: Präambel und \texttt{Settings}}{srcSound00a} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{31}{48}{python}{Sound: Konstruktor und \texttt{sounds()} von \texttt{Game}}{srcSound00b} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{50}{72}{python}{Sound: \texttt{watch\_for\_events()} von \texttt{Game}}{srcSound00c} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{74}{78}{python}{Sound: \texttt{sound\_play()} von \texttt{Game}}{srcSound00d} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{80}{84}{python}{Sound: \texttt{music\_start\_stop()} von \texttt{Game}}{srcSound00e} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{86}{91}{python}{Sound: \texttt{pause\_alter()} von \texttt{Game}}{srcSound00f} 
...
Zunächst wird dieser Wert auf das Attribut \texttt{volume} addiert (Bedenken Sie, dass ein negativer Veränderungswert hier die Lautstärke reduziert.). Anschließend wird der Wert auf das Intervall $[0, 1]$ begrenzt und abschließend die neu Lautstärke mit \texttt{pygame.mixer\-.music\-.set\-\_volume()}\myindex{pyg}{\texttt{mixer}!\texttt{music}!\texttt{set\_volume()}}\randnotiz{set\_volume()} gesetzt.

\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{93}{99}{python}{Sound: \texttt{volume\_alter()} von \texttt{Game}}{srcSound00g} 

Und zum Schluss kommt der gute Rest:

\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{101}{133}{python}{Sound: \texttt{draw()}, \texttt{update()}, \texttt{run()} und Aufruf von \texttt{Game}}{srcSound00h} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{1}{43}{python}{Sound-Stereo: Präamble, \texttt{Settings} und \texttt{Ground}}{srcSound01a} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{46}{70}{python}{Sound-Stereo: Konstruktor von \texttt{Tank}}{srcSound01b} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{72}{97}{python}{Sound-Stereo: \texttt{Tank.update()}}{srcSound01c} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{99}{102}{python}{Sound-Stereo: \texttt{Tank.stereo()}}{srcSound01d} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{104}{111}{python}{Sound-Stereo: \texttt{Tank.turn()} und \texttt{Tank.update\_imageindex()}}{srcSound01e} 
...
\newpage
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{114}{143}{python}{Sound-Stereo: Die Klasse \texttt{Bullet}}{srcSound01g} 

Der Rest des Quelltexts wird nur der Vollständigkeit wegen abgedruckt.

\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{154}{222}{python}{Sound-Stereo: Rest}{srcSound01h} 

...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{26}{43}{python}{Zeitsteuerung (2), Version 1.0: \texttt{Enemy}}{srcZeit00b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{46}{61}{python}{Zeitsteuerung (3), Version 1.0: \texttt{Bullet}}{srcZeit00c} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{64}{88}{python}{Zeitsteuerung (4), Version 1.0: Konstruktor und \texttt{run()} von \texttt{Game}}{srcZeit00d} 

Die Methoden \texttt{watch\_for\_events()} und \texttt{draw()} sind auch ohne Besonderheiten.

\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{90}{102}{python}{Zeitsteuerung (5), Version 1.0:  \texttt{watch\_for\_events()} und \texttt{draw()} von \texttt{Game}}{srcZeit00e} 
...
\newpage
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit00.py}{104}{110}{python}{Zeitsteuerung (6), Version 1.0:  \texttt{update()} und \texttt{new\_bullet()} von \texttt{Game}}{srcZeit00f} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit01.py}{74}{77}{python}{Zeitsteuerung (7), Version 1.1: Konstruktor von \texttt{Game}}{srcZeit01a} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit01.py}{111}{115}{python}{Zeitsteuerung (8), Version 1.1: \texttt{new\_bullet()} von \texttt{Game}}{srcZeit01b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit02.py}{74}{77}{python}{Zeitsteuerung (9), Version 1.2: Konstruktor von \texttt{Game}}{srcZeit02a} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit02.py}{111}{114}{python}{Zeitsteuerung (10), Version 1.2: \texttt{new\_bullet()} von \texttt{Game}}{srcZeit02b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit03.py}{90}{92}{python}{Zeitsteuerung (12), Version 1.3: \texttt{Timer}-Objekt erzeugen}{srcZeit03b} 
...
\lstsource{SRC/00 Einführung/10 Zeitsteuerung/zeit03.py}{126}{128}{python}{Zeitsteuerung (13), Version 1.3: \texttt{Timer}-Objekt verwenden}{srcZeit03c} 

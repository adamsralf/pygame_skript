...
\begin{enumerate}
    ...
    \item Beendet wird mit der Taste \keys{\esc} oder per Mausklick auf rote~„X“.\label{reqStandardBeenden}
    ...
    \item Alle Bitmaps werden in \texttt{pygame.sprite.Group}- oder \texttt{py\-game\-.sprite\-.Group\-Single}-Objekten abgelegt.\label{reqStandardGruppe}\myindex{pyg}{\texttt{sprite}!{\texttt{LayeredGroup}}}
...
\newpage
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles01.py}{1}{29}{python}{Bubbles (\reqref{reqStandard}.\ref{reqStandardGröße}) -- Präambel
}{srcBubbles01a}
...
\newpage
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles01.py}{31}{37}{python}{Bubbles (\reqref{reqStandard}.\ref{reqStandardHintergrund}) -- \texttt{Background
}}{srcBubbles01c}

In der Klasse \texttt{Game} werden in \texttt{\_\_init\_\_()} die Pygame üblichen Verdächtigen \texttt{init()}\myindex{pyg}{\texttt{init()}}, \texttt{Window()}\myindex{pyg}{\texttt{Window}} und \texttt{clock()}\myindex{pyg}{\texttt{time}!\texttt{Clock}} und aufgerufen bzw. erzeugt. Auch wird das Flag der Hauptprogrammschleife \texttt{running} initialisiert. Die Methoden \texttt{run()}, \texttt{watch\_for\_events()}, \texttt{update()} und \texttt{draw()} enthalten nur Basisfunktionalitäten, die hier nicht weiter erläutert werden müssen. 

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles01.py}{40}{76}{python}{Bubbles (\reqref{reqStandard}) -- Methoden von \texttt{Game}}{srcBubbles01d}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles01.py}{79}{999}{python}{Bubbles (\reqref{reqStandard}) -- Aufruf}{srcBubbles01s}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles02.py}{18}{20}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- Ergänzungen in \texttt{Settings}}{srcBubbles02a}
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles02.py}{35}{47}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{Timer}}{srcBubbles02b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles02.py}{59}{75}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{Bubble}}{srcBubbles02c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles02.py}{78}{87}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- Konstruktor von \texttt{Game}}{srcBubbles02d}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles02.py}{97}{103}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{draw()} und \texttt{update()} von \texttt{Game}}{srcBubbles02e}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles02.py}{105}{115}{python}{Bubbles (\reqref{reqBlasenErscheinen}) -- \texttt{spawn\_bubble()} von \texttt{Game}}{srcBubbles02f}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles03.py}{20}{21}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Settings}}{srcBubbles03a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles03.py}{106}{117}{python}{Bubbles (\reqref{reqBlasenanzahl}) -- Ergänzung von \texttt{Game} in \texttt{spawn\_bubbles()}}{srcBubbles03b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles04.py}{60}{69}{python}{Bubbles (\reqref{reqBlasenWachstum}.\ref{reqBlasenWachstumContainer}) -- \texttt{BubbleContainer}}{srcBubbles04a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles04.py}{18}{18}{python}{Bubbles (\reqref{reqBlasenWachstum}.\ref{reqBlasenWachstumMax}) -- Erweiterung von \texttt{Settings}}{srcBubbles04b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles04.py}{72}{91}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{Bubble}}{srcBubbles04c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles04.py}{125}{127}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{update()} in \texttt{Game}}{srcBubbles04d}  

Der BubbleContainer wird angelegt

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles04.py}{106}{108}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung im Konstruktor von \texttt{Game}}{srcBubbles04f}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles04.py}{129}{133}{python}{Bubbles (\reqref{reqBlasenWachstum}) -- Ergänzung von \texttt{spawn\_bubble()} in \texttt{Game}}{srcBubbles04e}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles05.py}{144}{149}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{collidepoint()} in \texttt{Game}}{srcbubbles05a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles05.py}{151}{161}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{set\_mousecursor()} in \texttt{Game}}{srcbubbles05b}  

Die Methode \texttt{update()} in \texttt{Game} muss noch um den Aufruf der Überprüfung erweitert werden.

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles05.py}{126}{129}{python}{Bubbles (\reqref{reqMauscursor}) -- \texttt{update()} in \texttt{Game}}{srcbubbles05c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles06.py}{113}{122}{python}{Bubbles (\reqref{reqBlasenzerplatzen}) -- \texttt{watch\_for\_event()} in \texttt{Game}}{srcbubbles06a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles06.py}{166}{169}{python}{Bubbles (\reqref{reqBlasenzerplatzen}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles06b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{23}{23}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandNull}) -- Erweiterung von \texttt{Game}}{srcbubbles07a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{104}{106}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{stung()} in \texttt{Bubble}}{srcbubbles07b}  

Der Aufruf von \texttt{stung()} erfolgt durch ein angepasstes \texttt{update()}.

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{85}{96}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Bubble}}{srcbubbles07b1}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{189}{192}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{sting()} in \texttt{Game}}{srcbubbles07c}  

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{152}{155}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandRadius}) -- \texttt{update()} in \texttt{Game}}{srcbubbles07d}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{24}{24}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- Erweiterung von \texttt{Settings}}{srcbubbles07e}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{109}{120}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- \texttt{Points}}{srcbubbles07f}  
...
\newpage
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles07.py}{132}{134}{python}{Bubbles (\reqref{reqPunktestand}.\ref{reqPunktestandAnzeige}) -- Erweiterung des Konstruktors von \texttt{Game}}{srcbubbles07g}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles08.py}{83}{83}{python}{Bubbles (\reqref{reqSpielende}) -- \texttt{Bubble.speed}}{srcbubbles08x}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles08.py}{155}{161}{python}{Bubbles (\reqref{reqSpielende}) -- Erweiterung von \texttt{update()} in \texttt{Game}}{srcbubbles08a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles08.py}{200}{212}{python}{Bubbles (\reqref{reqSpielende}) -- \texttt{check\_bubblecollision()} in \texttt{Game}}{srcbubbles08b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles08.py}{147}{153}{python}{Bubbles (\reqref{reqSpielende}) -- Hilfslinien in \texttt{Game}}{srcbubbles08c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles09.py}{75}{83}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- \texttt{Bubble}}{srcBubbles09a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles09.py}{130}{134}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- Konstruktor von \texttt{Game}}{srcBubbles09b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles09.py}{162}{176}{python}{Bubbles (\reqref{reqZeitanpassungen}) -- \texttt{Game.spawn\_bubble()}}{srcBubbles09c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{130}{131}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Erweiterung von \texttt{Game}}{srcbubbles10a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{63}{67}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Änderung Konstruktor von \texttt{BubbleContainer}}{srcbubbles10b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{137}{140}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Änderung vom Konstruktor von \texttt{Game}}{srcbubbles10c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{75}{98}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Konstruktor von \texttt{Bubble} und \texttt{update()}}{srcbubbles10d}  

Ändert sich der Modus, muss die andere Farbe nachgeladen werden. Dies erfüllt die Methode \texttt{set\_mode} in \texttt{Bubble}.

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{100}{103}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- \texttt{set\_mode()} in \texttt{Bubble}}{srcbubbles10e}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{212}{228}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- \texttt{check\_bubblecollision()} in \texttt{Game}}{srcbubbles10f}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles10.py}{230}{242}{python}{Bubbles (\reqref{reqKollisionanzeigen}) -- Wartezeit in \texttt{run()}}{srcbubbles10g}  
...
\br{Pause}{reqPause}
 Mit der rechten Maustaste oder der Taste \keys{P} springt das Spiel in den Pausenmodus oder beendet diesen. Der aktuelle Spielstand friert ein und wird „eingegraut“. 
\er
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles11.py}{154}{156}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Konstruktor} in \texttt{Game}}{srcbubbles11b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles11.py}{158}{173}{python}{Bubbles (\reqref{reqPause}) -- \texttt{watch\_for\_events()} in \texttt{Game}}{srcbubbles11c}  

Für die Darstellung der Pause, habe ich die -- vielleicht etwas überflüssige -- Klasse \texttt{Pause} implementiert. 

\newpage
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles11.py}{75}{80}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Pause}}{srcbubbles11d}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles11.py}{156}{156}{python}{Bubbles (\reqref{reqPause}) -- \texttt{Konstruktor} in \texttt{Game}}{srcbubbles11g}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles11.py}{189}{194}{python}{Bubbles (\reqref{reqPause}) -- \texttt{setpause()} in \texttt{Game}}{srcbubbles11h}  
...
Die Grundidee der Implementierung ist dabei, dass mit Hilfe von zwei Flags\index{Flag}\randnotiz{Flag} der Status des Spiels festgelegt wird. Wie bei der Pause brauchen wir ein Flag, welches steuert, ob der halbtransparente Vordergrund über das Spiel gelegt wird (\texttt{restarting}). Dies ist immer dann der Fall, wenn die Kollisionsprüfung der Blasen eine Kollision feststellt. 

Das andere Flag -- \texttt{do\_start} -- markiert, ob der Spieler einen Neustart möchte. An den entscheidenden Stellen in \texttt{update()} und \texttt{draw()} werden dann diese Flags abgefragt.
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles12.py}{75}{80}{python}{Bubbles (\reqref{reqNeustart}) -- von \texttt{Pause} zu \texttt{Message}}{srcbubbles12b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles12.py}{151}{154}{python}{Bubbles (\reqref{reqNeustart}) -- Umbau Konstruktor von \texttt{Game}}{srcbubbles12c}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles12.py}{195}{203}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{restart()} in \texttt{Game}}{srcbubbles12d}  


Aufgerufen wird die Methode in \texttt{update()}, wenn das entsprechende Flag \texttt{do\_start} gesetzt ist. Auch wird in \texttt{update()} der Neustart-Bildschirm in die Spritegroup eingefügt und das Flag \texttt{restarting} auf \true\ gesetzt, wenn eine Kollision erkannt wurde. 

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles12.py}{182}{193}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{update()} in \texttt{Game}}{srcbubbles12e}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles12.py}{163}{169}{python}{Bubbles (\reqref{reqNeustart}) -- Erweiterung von \texttt{watch\_for\_events()}}{srcbubbles12f}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles12.py}{281}{281}{python}{Bubbles (\reqref{reqNeustart}) -- \texttt{run()} in \texttt{Game}}{srcbubbles12g}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles13.py}{138}{140}{python}{Bubbles (\reqref{reqSound}) -- \texttt{SOUND\_CONTAINER}}{srcbubbles13a}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles13.py}{149}{151}{python}{Bubbles (\reqref{reqSound}) -- \texttt{SOUND\_CONTAINER} auffüllen}{srcbubbles13b}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles13.py}{230}{233}{python}{Bubbles  (\reqref{reqSound}.\ref{reqSoundErscheinen}) -- \texttt{spawn\_bubble()}}{srcbubbles13c}  

Dann, wenn in \texttt{sting()} eine Blase zerplatzt (\zeiref{srcBubble1304}):

\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles13.py}{256}{258}{python}{Bubbles (\reqref{reqSound}.\ref{reqSoundZerstechen}) -- \texttt{sting()}}{srcbubbles13d}  
...
\lstsource{SRC/02 Beispiele/02 Bubbles/bubbles13.py}{190}{195}{python}{Bubbles (\reqref{reqSound}.\ref{reqSoundBerühren}) -- \texttt{update()}}{srcbubbles13e}  

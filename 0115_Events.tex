...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{42}{77}{python}{Events (2) -- Klasse \texttt{Particle}}{srcEvent01c}
...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{80}{105}{python}{Events (2) -- Klasse \texttt{Box}}{srcEvent01d}

Und jetzt das Hauptprogramm: Im Konstruktor werden die Buttons, Boxen und Partikel angelegt und Spritegroups zugeordnet.

\lstsource{SRC/00 Einführung/15 Events/events01.py}{108}{123}{python}{Events (2) --  Konstruktor von \texttt{Game}}{srcEvent01e}

Die Methode \texttt{run()} ist nahezu langweilig.

\lstsource{SRC/00 Einführung/15 Events/events01.py}{125}{135}{python}{Events (2) --  \texttt{Game.run()}}{srcEvent01f}
...
\lstsource{SRC/00 Einführung/15 Events/events01.py}{137}{151}{python}{Events (2) --  \texttt{Game.watch\_for\_events()}}{srcEvent01g}

Der Rest wird hier der Vollständigkeit abgedruckt.

\lstsource{SRC/00 Einführung/15 Events/events01.py}{153}{181}{python}{Events (2) --  Der Rest von \texttt{Game}}{srcEvent01h}
...
\lstsource{SRC/00 Einführung/15 Events/events02.py}{138}{140}{python}{Events (3) -- Timer}{srcEvent02b}
...
\lstsource{SRC/00 Einführung/15 Events/events02.py}{169}{170}{python}{Events (3) -- Event}{srcEvent02c}

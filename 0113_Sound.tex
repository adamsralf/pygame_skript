...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{1}{36}{python}{Sound: Präambel und \texttt{Settings}}{srcSound00a} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{39}{56}{python}{Sound: Konstruktor und \texttt{sounds()} von \texttt{Game}}{srcSound00b} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{58}{80}{python}{Sound: \texttt{watch\_for\_events()} von \texttt{Game}}{srcSound00c} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{82}{86}{python}{Sound: \texttt{sound\_play()} von \texttt{Game}}{srcSound00d} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{88}{92}{python}{Sound: \texttt{music\_start\_stop()} von \texttt{Game}}{srcSound00e} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{94}{99}{python}{Sound: \texttt{pause\_alter()} von \texttt{Game}}{srcSound00f} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{101}{107}{python}{Sound: \texttt{volume\_alter()} von \texttt{Game}}{srcSound00g} 

\newpage
Und zum Schluss kommt der gute Rest:

\lstsource{SRC/00 Einführung/13 Sound/sound00.py}{109}{133}{python}{Sound: \texttt{draw()}, \texttt{update()}, \texttt{run()} und Aufruf von \texttt{Game}}{srcSound00h} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{1}{47}{python}{Sound-Stereo: Präamble, \texttt{Settings} und \texttt{Ground}}{srcSound01a} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{50}{76}{python}{Sound-Stereo: Konstruktor von \texttt{Tank}}{srcSound01b} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{78}{103}{python}{Sound-Stereo: \texttt{Tank.update()}}{srcSound01c} 
...
\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{120}{163}{python}{Sound-Stereo: Konstruktor von \texttt{Bullet} und \text{update()}}{srcSound01g} 

Der Rest des Quelltexts wird nur der Vollständigkeit wegen abgedruckt.

\lstsource{SRC/00 Einführung/13 Sound/sound01.py}{166}{222}{python}{Sound-Stereo: Rest}{srcSound01h} 
